...
const initData = {
    pre_heading: "EBA",
    heading: "Book your events",
    content: "Best place to book your events",
    btn_1: "Explore",
    btn_2: "Create"
}
                    ...
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-7">
                            ...
                            <div className="button-group">
                                <a className="btn btn-bordered-white" href="#exp"><i className="icon-rocket mr-2" />{this.state.data.btn_1}</a>
